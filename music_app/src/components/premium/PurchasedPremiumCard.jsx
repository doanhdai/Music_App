...
const PurchasedPremiumCard = ({ isActive, title, price, duration, descriptions }) => {
    ...
    return (
      <div className="bg-gray-900 p-5 rounded-lg w-72 relative text-white">
        ...
        <p className="mt-2">
          <span className="text-lg font-bold">{price}</span> dùng trong <span className="text-lg font-bold">{duration}</span>
        </p>
