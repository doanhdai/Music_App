...
const ManagerSong = () => {
  ...
  return (
   <div className='pt-3 mx-[38px]'>
        ...
        <div className="grid grid-cols-5 sm:grid-cols-[1fr_4fr_2fr_2fr_1.5fr] mt-7 p-4 text-[#fff]">
          <p>Mã bài hát</p>
          <p>Tên bài hát</p>
        ...
        {baihat.map((item, index) => (
          ...
          >
            ...
            <p className="text-[15px] flex items-center"> <img className="inline w-10 mr-2 " src={assets.mck} /> {item.ten_bai_hat}</p>
