...
let theloaiList = [
    { ma_the_loai: 'TL1', ten_the_loai: 'POP' },
    { ma_the_loai: 'TL2', ten_the_loai: 'R&B' },
    { ma_the_loai: 'TL3', ten_the_loai: 'Bolero' },
    { ma_the_loai: 'TL4', ten_the_loai: 'Romantic' }
]
...
const ManagerType = () => {
    ...
    const [arrayValue, setArrayValue] = useState(theloaiList);
